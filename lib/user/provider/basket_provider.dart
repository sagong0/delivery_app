...
import 'package:actual_two/user/model/basket_item_model.dart';
import 'package:actual_two/user/model/patch_basket_body_model.dart';
import 'package:actual_two/user/repository/user_me_repository.dart';
...
class BasketStateNotifier extends StateNotifier<List<BasketItemModel>> {
  ...
  Future<void> addToBasket({
    ...
    // 응답이 성공할 거라고 가정하고 상태를 먼저 업데이트 함
    updateBasketDebounce.setValue(null);
  }

  Future<void> removeFromBasket({
    required ProductModel product,
    // true : count 와 상관없이 아예 삭제한다
    bool isDelete = false,
  }) async {
    // 1) 장바구니에 상품이 존재 할 때
